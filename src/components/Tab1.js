...
export default function Tab1() {
    return (
        <div className=' ml-5 '>
            ...
            <div class="flex items-center space-x-4 m-5 p-5 ring-1 ring-slate-400 rounded-lg hover:rounded-lg  hover:ring-pink-500">
                <img class=" h-20 w-20 rounded-full object-cover" src="https://preview.colorlib.com/theme/confer/img/bg-img/11.jpg" alt="profile" />
                <div>
                    <h2 class="text-lg font-semibold">Capdm Executive Conference</h2>
                    <h2><span className='text-gray-400'>by</span>Amanda Hudson <span className='text-gray-400'>/ Ceo of Confer</span></h2>
                </div>
                <div>
                    <div className='flex space-x-3'>
            ...
            <div class="flex items-center space-x-4 m-5 p-5 ring-1 ring-slate-400 rounded-lg hover:rounded-lg  hover:ring-pink-500">
                <img class=" h-20 w-20 rounded-full object-cover" src="https://preview.colorlib.com/theme/confer/img/bg-img/13.jpg" alt="profile" />
                <div>
                    <h2 class="text-lg font-semibold">Street Food Convention</h2>
                    <h2><span className='text-gray-400'>by</span>Amanda Hudson <span className='text-gray-400'>/ Ceo of Confer</span></h2>
                </div>
                <div>
                    <div className='flex space-x-3'>
